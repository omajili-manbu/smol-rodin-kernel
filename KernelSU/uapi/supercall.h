...
// UAPI version: bumped to 2 for allowlist v4 root profile flags.
// Newer KSU manager apps require the driver to report this version via
// ksu_get_info_cmd.uapi_version. Backported from KSU v3.2.5.
...
/* deprecated: used by legacy ksud that does not know about uapi_version */
...
/* deprecated: old ioctl with size=0, kept for backward compatibility */
